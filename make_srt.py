...
def main() -> None:
    ...
    p.add_argument("--min-dur", type=float, default=DEFAULTS["min_dur"], help="ความยาวขั้นต่ำต่อซับ (วินาที) (เริ่มต้น %(default)s)")
    p.add_argument("--lead", type=float, default=DEFAULTS["lead"], help="เผื่อเวลาก่อนคำแรก (วินาที) (เริ่มต้น %(default)s)")
    p.add_argument("--tail", type=float, default=DEFAULTS["tail"], help="เผื่อเวลาหลังคำสุดท้าย (วินาที) (เริ่มต้น %(default)s)")
    p.add_argument("--gap", type=float, default=DEFAULTS["gap"], help="ช่องว่างขั้นต่ำระหว่างซับสองก้อน (เริ่มต้น %(default)s)")
    p.add_argument("--window-pad", type=float, default=DEFAULTS["window_pad"], help="ขยายกรอบค้นหาของแต่ละก้อน (วินาที) (เริ่มต้น %(default)s)")
